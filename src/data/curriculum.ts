...
export const curriculum: Lesson[] = [
  ...
  },
  {
    ...
    objectives: ['تجربة لون صوتي مختلف عن الأسلوب الغربي التقليدي.', 'عزف منعطفات حول مي وصول.', 'فهم حدود البيانو مع المقام دون إحباط.'],
...
export const curriculumUnitsMeta = [
  ...
  { index: 5, title: U5, summary: 'ألحان كاملة الجملة من التراث العالمي والموسيقى الكلاسيكية.' },
